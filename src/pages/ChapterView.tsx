    ...
    <div className="h-screen flex overflow-hidden bg-[#F8F9FA] font-sans" id="classroom-portal-root">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
          ...
          <main className="flex-1 bg-white overflow-y-auto p-4 sm:p-6 lg:p-8 border-r border-[#E2E8F0]">
          ...
          <aside className="w-full md:w-[380px] bg-[#F8F9FA] overflow-y-auto p-4 sm:p-6 lg:p-8 shrink-0 border-t md:border-t-0 flex flex-col gap-6 text-left">
